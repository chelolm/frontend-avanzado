...
export class ProfileService {
 ...
 tasks_endpoint = 'tasks';
  ...
  getUsers(): Observable<any /* UserOptions */> {
    //return of(this.mockUser as any);
    return this.http.get<any>(AppSettings.API_ENDPOINT_USER);
  }

  loadProfile(): Observable<any /* UserOptions */> {
    //return of(this.mockUser as any);
    return this.http.get<any>(AppSettings.API_ENDPOINT_PROFILE);
  }
  logout(): void {
    /*  this.store$.dispatch(new UserActions.Logout()); */
  }
  public updateProfile(profile: any /* User */): Observable<any /* User */> {
      return this.http.put<any>(AppSettings.API_ENDPOINT_PROFILE, profile);
